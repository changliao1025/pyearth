...
def ladder_plot_xy_data(aX_all,  aY_all,  sFilename_out,iDPI_in = None, aFlag_trend_in = None,  iReverse_y_in = None,    \
     iFlag_scientific_notation_x_in=None, \
    iSize_x_in = None,  iSize_y_in = None,  ncolumn_in = None,  dMax_x_in = None,  dMin_x_in = None,  dMax_y_in = None, \
        dMin_y_in = None,  dSpace_y_in = None, aMarker_in = None, aColor_in = None, aLinestyle_in = None, aLinewidth_in=None, \
            aLabel_point_in = None,  aTick_label_x_in = None,  aLocation_legend_in =None, sLabel_x_in = None, sLabel_y_in = None,  \
                aLabel_legend_in = None,  sLocation_legend_in=None, sFormat_x_in =None, sFormat_y_in =None, sTitle_in = None):
    ...
    for i in np.arange(1, nData+1):
        ...
        y1 = aY_all[i-1]
        ax.step( x1, y1, \
                 color = aColor[i-1], linestyle = aLinestyle[i-1] ,   linewidth =aLinewidth[i-1], \
                 marker = aMarker[i-1] ,\
    ...
    if (iFlag_format_x ==1):
        ax.xaxis.set_major_formatter(ticker.FormatStrFormatter(  sFormat_x ))
    if (iFlag_format_y ==1):
