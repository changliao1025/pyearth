...
def boxplot_data(aData_in,\
    ...
    for i in np.arange(1, nData + 1, 1):
        ...
        for j in range(1, nData1+1, 1):
            ...
            height = y_top-y_bot            
            #draw box
            rect = patches.Rectangle((x_left, y_bot), dWidth, height, linewidth=0.5, facecolor=aColor[j-1], edgecolor = 'k') #, hatch = aHatch[j-1 ]
            ...
            for k in range(len(dummy_index)):
                ...
                ax.plot(x0, y0, marker="o", markersize=3, markeredgecolor="black", markerfacecolor="white")
                pass
