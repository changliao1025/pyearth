...
def merge_vector_polygon_data(iFiletype_in,
    ...
    pLayer_out = pDataset_out.CreateLayer('cell', pSpatial_reference_gcs, ogr.wkbPolygon)
    # Add one attribute
    pLayer_out.CreateField(ogr.FieldDefn('id', ogr.OFTInteger64)) #long type for high resolution
    pLayer_out.CreateField(ogr.FieldDefn(sVar, ogr.OFTReal)) #long type for high resolution     
