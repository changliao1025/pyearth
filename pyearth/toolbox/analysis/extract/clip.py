...
def clip_raster_by_polygon(sFilename_raster_in, sFilename_polygon_in, sFilename_raster_out, sFormat='GTiff'):
    """
    ...
    raster = gdal.Open(sFilename_raster_in, gdal.GA_ReadOnly)
    return
