...
def scipy_bivariate_kde(x, y, bw, gridsize, cut, clip):
    ...
    x_support = kde_support(data[:, 0], bw_x, gridsize, cut, clip[0])
    y_support = kde_support(data[:, 1], bw_y, gridsize, cut, clip[1])
