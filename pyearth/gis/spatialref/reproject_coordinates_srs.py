...
def reproject_coordinates_srs(dx_in, dy_in, pSpatial_reference_source_in, pSpatial_reference_target_in=None):
...
def reproject_coordinates_srs_batch(aX_in, aY_in, pSpatial_reference_source_in, pSpatial_reference_target_in=None):
